...
public class HashMapTest {
    ...
    private synchronized void addPerson() {//ex3.1 use synchronized function

		people.put(RandomUtils.randomString(), RandomUtils.randomInteger());
    }

    private synchronized void deletePeople(String pattern) {//ex3.1 use synchronized function
    ...
    private synchronized void printPeople() {//use synchronized function
