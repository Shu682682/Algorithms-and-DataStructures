...
public class BankAccounts {
    ...
    public static void transferMoney(Account fromAccount,
		...
		//ex3.5 Use System.identityHashCode to define account sequence and avoid deadlock.
		class Helper {
		...
		if (fromHash < toHash) {
			...
			//ex3.5 Use tieLock to ensures that synchronization can be consistently and safely.
